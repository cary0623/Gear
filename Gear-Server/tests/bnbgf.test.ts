...
describe("bnbGreenfield", async () => {
  it("static_data", async () => {
    ...
    console.log(bnbGreenfield.gearFoldName);
  });
  ...
  it("createBucket", async () => {
    const bucketName = "gear-test-bucket";
  ...
  it("createObject_bug_0", async () => {
    ...
    const log = {
      ...
      gearAddress: "0x89411D88d5235AD86D80892EC6545563F0dEd9C5",
      txhash:
